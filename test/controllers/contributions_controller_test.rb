...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { puntos: @contribution.puntos, text: @contribution.text, tipo: @contribution.tipo, titulo: @contribution.titulo, url: @contribution.url }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { puntos: @contribution.puntos, text: @contribution.text, tipo: @contribution.tipo, titulo: @contribution.titulo, url: @contribution.url }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
